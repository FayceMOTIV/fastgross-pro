...
const recentOrders: Order[] = [
  { id: "ORD-2847", client: "Istanbul Kebab", clientInitials: "IK", clientColor: "from-amber-500 to-orange-600", amount: 847.50, status: "delivering", time: "Il y a 12 min", items: 24, progress: 75 },
  { id: "ORD-2846", client: "Napoli Pizza", clientInitials: "NP", clientColor: "from-red-500 to-rose-600", amount: 1250.00, status: "preparing", time: "Il y a 25 min", items: 36, progress: 45 },
  { id: "ORD-2845", client: "Brooklyn Burger", clientInitials: "BB", clientColor: "from-violet-500 to-purple-600", amount: 623.80, status: "pending", time: "Il y a 32 min", items: 18, progress: 10 },
  { id: "ORD-2844", client: "Tacos Avenue", clientInitials: "TA", clientColor: "from-cyan-500 to-blue-600", amount: 445.20, status: "delivered", time: "Il y a 45 min", items: 12, progress: 100 },
  { id: "ORD-2843", client: "O'Délices", clientInitials: "OD", clientColor: "from-emerald-500 to-teal-600", amount: 892.00, status: "delivered", time: "Il y a 1h", items: 28, progress: 100 },
];

const drivers: Driver[] = [
  { id: "1", name: "Karim M.", initials: "KM", status: "online", deliveries: 8, location: "Lyon Centre", color: "bg-gradient-to-br from-emerald-500 to-teal-600", rating: 4.9 },
  { id: "2", name: "Ahmed R.", initials: "AR", status: "busy", deliveries: 12, location: "Montpellier Sud", color: "bg-gradient-to-br from-blue-500 to-indigo-600", rating: 4.8 },
  { id: "3", name: "Youssef B.", initials: "YB", status: "online", deliveries: 6, location: "Bordeaux Lac", color: "bg-gradient-to-br from-violet-500 to-purple-600", rating: 5.0 },
  { id: "4", name: "Mehdi T.", initials: "MT", status: "offline", deliveries: 0, location: "—", color: "bg-gradient-to-br from-slate-400 to-slate-500", rating: 4.7 },
];

const topClients: TopClient[] = [
  { id: "1", name: "Istanbul Kebab", initials: "IK", revenue: 12450, orders: 48, trend: 15, color: "bg-gradient-to-br from-amber-400 to-orange-500" },
  { id: "2", name: "Napoli Pizza", initials: "NP", revenue: 9870, orders: 36, trend: 8, color: "bg-gradient-to-br from-red-400 to-rose-500" },
  { id: "3", name: "Brooklyn Burger", initials: "BB", revenue: 7650, orders: 28, trend: 22, color: "bg-gradient-to-br from-violet-400 to-purple-500" },
  { id: "4", name: "Tacos Avenue", initials: "TA", revenue: 5420, orders: 22, trend: 12, color: "bg-gradient-to-br from-cyan-400 to-blue-500" },
];

const recentAlerts: Alert[] = [
  { id: "1", type: "success", message: "Nouveau client Tacos Avenue ajouté", time: "Il y a 5 min" },
  { id: "2", type: "warning", message: "Stock faible: Sauce blanche 5L", time: "Il y a 15 min" },
  { id: "3", type: "info", message: "Karim M. a terminé sa tournée Lyon Centre", time: "Il y a 30 min" },
];
