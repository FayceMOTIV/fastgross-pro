...
import { X, Sparkles, Zap, Users, TrendingUp, Mail, Scan, Radar, FileCheck, Rocket, Target, Euro } from 'lucide-react'
...
const bannerConfig = {
  dashboard: {
    ...
    description: "Vue d'ensemble de votre prospection. Chaque prospect trouve, chaque email envoye, chaque reponse apparait automatiquement.",
  ...
  scanner: {
    ...
    description: "Entrez un secteur et une ville. L'outil cherche automatiquement des prospects qualifies, recupere leurs emails, et les ajoute a votre pipeline. Il tourne tout seul chaque jour.",
  ...
  forgeur: {
    ...
    description: "Un email unique pour chaque prospect avec son nom, son entreprise, son secteur. Chaque message semble ecrit a la main. L'envoi est automatique.",
  ...
  radar: {
    ...
    description: "Kanban automatique. Ceux qui ouvrent montent. Ceux qui repondent passent en 'Interesse'. Vous ne contactez QUE les prospects chauds.",
  ...
  proof: {
    ...
    description: "Rapport PDF avec toutes vos stats. Taux d'ouverture, de reponse, clients convertis, CA genere.",
  ...
  autopilot: {
    ...
    description: "Configurez votre niche une seule fois. Chaque jour a 9h l'outil trouve 30-50 prospects, envoie des emails, et vous notifie quand quelqu'un repond.",
  ...
  niche: {
    ...
    description: "Choisissez vos secteurs, vos villes, vos criteres. L'outil ne cherche que des prospects qui correspondent a votre offre.",
  ...
  analytics: {
    ...
    description: "Suivez l'evolution de vos campagnes, identifiez ce qui fonctionne, optimisez votre approche.",
...
export default function DemoBanner({ page, onHide }) {
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${config.gradient} border border-white/5 mb-8`}>
      {/* Background pattern */}
      ...
      <div className="relative p-6 sm:p-8">
        <div className="flex items-start gap-4 sm:gap-6">
          {/* Icon */}
          <div className={`flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-2xl ${config.iconBg} flex items-center justify-center`}>
