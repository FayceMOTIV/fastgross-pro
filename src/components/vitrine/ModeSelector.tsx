...
import { Users, Truck, BarChart3, Settings, ShoppingCart, Building2 } from 'lucide-react';
import { cn } from '@/lib/utils';

const modes = [
  {
    name: 'Commercial',
    description: 'CRM, clients, prospection IA',
    href: '/commercial',
    icon: Users,
  ...
  {
    name: 'Manager',
    description: 'Supervision, statistiques',
    href: '/supervision',
    icon: BarChart3,
