...
const features = [
  ...
  },
  {
    ...
    title: 'IA Tournées',
    subtitle: null,
    description: 'Optimise les routes de livraison. Créneaux par type de resto, trafic temps réel, multi-dépôts.',
  ...
  },
  {
    ...
    title: 'IA Stocks',
    subtitle: null,
    description: 'Prédit les ruptures 2 semaines avant. Saisonnalité intégrée (12 mois + 7 jours), alertes DLC.',
