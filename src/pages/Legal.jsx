          ...
          <div className="glass-card p-8 lg:p-12">
            ...
            {activeTab === 'cgv' && (
              <article className="prose prose-invert prose-sm max-w-none">
                ...
                <h2>1. Objet</h2>
                <p>
                  Les présentes conditions générales de vente régissent l'utilisation du service Face Media Factory,
                  plateforme SaaS de prospection commerciale assistée par intelligence artificielle.
                </p>

                <h2>2. Définitions</h2>
                <ul>
                  <li><strong>"Service"</strong> : la plateforme Face Media Factory accessible via facemediafactory.com</li>
                  <li><strong>"Utilisateur"</strong> : toute personne physique ou morale utilisant le Service</li>
                  <li><strong>"Abonnement"</strong> : formule d'accès au Service (Solo, Pro, Agency)</li>
                </ul>

                <h2>3. Accès au Service</h2>
                <p>
                  L'accès au Service nécessite la création d'un compte et la souscription à un Abonnement payant.
                  Un essai gratuit de 14 jours est proposé pour le plan Pro.
                </p>

                <h2>4. Tarifs et paiement</h2>
                <p>
                  Les tarifs sont indiqués en euros TTC. Le paiement est effectué mensuellement par carte bancaire via Stripe.
                ...
                <p>
                  Les Abonnements sont sans engagement. L'Utilisateur peut résilier à tout moment depuis les paramètres
                ...
                <p>
                  Le Service, son code, son design et son contenu sont la propriété exclusive de Face Media Factory.
                  L'Utilisateur conserve la propriété de ses données.
                </p>

                <h2>8. Limitation de responsabilité</h2>
                <p>
                  Face Media Factory ne saurait être tenu responsable des dommages indirects résultant de l'utilisation
                  du Service. La responsabilité totale est limitée au montant des sommes versées au cours des 12 derniers mois.
                </p>

                <h2>9. Données personnelles</h2>
                <p>
                  Le traitement des données personnelles est décrit dans notre{' '}
                  <button onClick={() => handleTabChange('privacy')} className="text-brand-400 hover:underline">
                ...
                <p>
                  Les présentes CGV sont soumises au droit français. Tout litige sera porté devant les tribunaux de Paris.
                </p>
            ...
            {activeTab === 'privacy' && (
              <article className="prose prose-invert prose-sm max-w-none">
                ...
                <p>
                  Face Media Factory<br />
                  Email : <a href="mailto:contact@facemediafactory.com" className="text-brand-400 hover:underline">contact@facemediafactory.com</a>
                </p>
                ...
                <ul>
                  ...
                  <li><strong>Intérêt légitime</strong> : amélioration, sécurité</li>
                ...
                <p>
                  Certains prestataires sont basés aux États-Unis. Les transferts sont encadrés par les
                ...
                <p>
                  ...
                  <a href="mailto:privacy@facemediafactory.com" className="text-brand-400 hover:underline">
                ...
                <p>
                  Cette politique peut être modifiée. Les utilisateurs seront informés par email
            ...
            {activeTab === 'mentions' && (
              <article className="prose prose-invert prose-sm max-w-none">
                ...
                <p>
                  ...
                  Dublin 4, Irlande<br />
                  <br />
                  Le Service est hébergé sur des serveurs situés dans l'Union Européenne (région europe-west1).
                </p>
                ...
                <p>
                  Toute reproduction, représentation, modification, publication, adaptation ou diffusion,
                  totale ou partielle, du contenu de ce site sans autorisation préalable écrite est interdite.
                </p>

                <h2>Marques</h2>
                <p>
                  "Face Media Factory", le logo et les noms des fonctionnalités (Scanner, Forgeur, Radar, Proof)
                  sont des marques déposées ou en cours de dépôt.
                </p>

                <h2>Crédits</h2>
                <ul>
                  <li><strong>Design & Développement</strong> : Face Media Factory</li>
                  <li><strong>Icônes</strong> : Lucide Icons (ISC License)</li>
                  <li><strong>Polices</strong> : Google Fonts (Outfit, DM Sans, JetBrains Mono)</li>
                  <li><strong>Framework CSS</strong> : Tailwind CSS</li>
                  <li><strong>Framework JS</strong> : React</li>
                </ul>

                <h2>Liens hypertextes</h2>
                <p>
                  Le site peut contenir des liens vers des sites tiers. Face Media Factory n'exerce aucun
                ...
                <p>
                  ...
                  <a href="mailto:legal@facemediafactory.com" className="text-brand-400 hover:underline">
