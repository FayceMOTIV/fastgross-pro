...
export const ReportDocument = ({ report }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <Text style={styles.title}>Rapport de Valeur</Text>
        <Text style={styles.subtitle}>{report.clientName} — {report.periodLabel}</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statBox}>
            <Text style={styles.statValue}>{report.stats?.emailsSent || 0}</Text>
            <Text style={styles.statLabel}>Emails envoyés</Text>
          </View>
          <View style={styles.statBox}>
            <Text style={styles.statValue}>{report.stats?.openRate || 0}%</Text>
            <Text style={styles.statLabel}>Taux d'ouverture</Text>
          </View>
          <View style={styles.statBox}>
            <Text style={styles.statValue}>{report.stats?.replyRate || 0}%</Text>
            <Text style={styles.statLabel}>Taux de réponse</Text>
          </View>
          <View style={styles.statBox}>
            <Text style={styles.statValue}>{report.stats?.replied || 0}</Text>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Valeur estimée générée</Text>
