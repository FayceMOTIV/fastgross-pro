...
export default function AppearanceSettings() {
  ...
  return (
    <div className="bg-white/5 rounded-2xl border border-white/10 p-8 space-y-6">
      ...
      <div>
        <h3 className="text-sm font-medium text-gray-600 mb-4">Theme</h3>
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-400">Interface lumineuse</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-400">Reduit la fatigue oculaire</p>
              </div>
            </div>
            <div className="w-full h-20 rounded-lg bg-gray-50 border border-gray-300 p-2">
